  ...
  <div class="px-[12%] py-[3%]">
    ...
    <div class="grid grid-cols-3 gap-6" v-if="hiddenSupport">
      ...
      >
        ...
        <p class="dark:text-white">
          Especializado em instalação e configuração de computadores,
          assistência técnica, aconselhamento e feedback de opções de compras
          para computadores.
        </p>
      </div>
      <div
        class="flex flex-col mt-12 gap-4 p-4 rounded-md shadow-lg bg-header dark:bg-black">
        <div class="dark:bg-white dark:rounded-full dark:p-1 w-max">
          <img src="../../assets/img/ip.png" width="42" alt="" />
        </div>
        <h2 class="font-bold dark:text-white">
          Instalação e configuração de Impressoras
        </h2>
        <p class="dark:text-white">
          Montagem, Instalação e configuração de Impressoras
        </p>
      </div>
      <div
        class="flex flex-col mt-12 gap-4 p-4 rounded-md shadow-lg bg-header dark:bg-black"
      ...
      <div class="dark:bg-white dark:rounded-full dark:p-1 w-max">
        ...
        <h2 class="font-bold dark:text-white">Configuração de redes de Computadores</h2>
        <p class="dark:text-white">
